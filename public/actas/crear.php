...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $resultado = $actas->crearActa($acta_codi, $acta_fecha, $acta_archivo, $acta_recibido, $acta_planilla, $mate_id, $opor_id, $usr_id);
        if ($resultado) {
...
<div class="container mt-5">
    <h1 class="mb-4">Crear Nueva Acta</h1>
    <?php if ($error): ?>
    ...
    <form action="crear.php" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            ...
            <input type="text" name="acta_codi" id="acta_codi" class="form-control" required>
        </div>
        <div class="mb-3">
            <label for="acta_fecha" class="form-label">Fecha del Acta:</label>
            <input type="date" name="acta_fecha" id="acta_fecha" class="form-control" required>
        </div>
        <div class="mb-3">
            ...
            <input type="file" name="acta_archivo" id="acta_archivo" class="form-control-file d-none" required>
        </div>
        <div class="mb-3">
            <label for="acta_recibido" class="form-label">Fecha de Recepción del Acta:</label>
            <input type="date" name="acta_recibido" id="acta_recibido" class="form-control" required>
        </div>
        <div class="mb-3">
            ...
            <input type="file" name="acta_planilla" id="acta_planilla" class="form-control-file d-none" required>
        </div>
        <div class="mb-3">
            ...
            <select name="mate_id" id="mate_id" class="form-control" required>
                ...
                <option value="<?php echo $row['id']; ?>"><?php echo $row['mate_code'] . ' - ' . $row['mate_name']; ?></option>
                <?php endwhile; ?>
            </select>
        </div>
        <div class="mb-3">
            ...
            <select name="opor_id" id="opor_id" class="form-control" required>
                ...
                <option value="<?php echo $row['id']; ?>"><?php echo $row['opor_code']; ?></option>
                <?php endwhile; ?>
            </select>
        </div>
        <div class="mb-3">
            ...
            <select name="usr_id" id="usr_id" class="form-control" required>
                ...
                <option value="<?php echo $row['id']; ?>"><?php echo $row['user_nombre']; ?></option>
                <?php endwhile; ?>
            </select>
        </div>
